...
- `src/core/pse.ts`: Builds Google Programmable Search constraints and generated config helpers.
...
- Regenerate Google Programmable Search files with `npm run generate:pse-config`.
...
- Do not show generated Google `site:` constraints in the visible search input.
