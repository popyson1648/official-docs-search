...
const messages: Record<UiLanguage, Messages> = {
  en: {
    ...
    autoNonOfficial: "Use non-official references when official ones aren't available online",
    sources: "Sources",
    help: "Search syntax",
    close: "Close",
    uiLanguage: "UI",
    ...
    resultReferenceCount: "{count} references",
    resultSourcesLabel: "Sources",
  ...
  ja: {
    ...
    autoNonOfficial: "ウェブで読める公式リファレンスがない場合、非公式リファレンスを使う",
    sources: "ソース",
    help: "検索方法",
    close: "閉じる",
    uiLanguage: "UI",
    ...
    resultReferenceCount: "{count}件の参照先",
    resultSourcesLabel: "参照先",
